...
const searchData = [
  ...
  { title: 'PRO 단가 (프로)', desc: '5명 100만원 / 10명 200만원 / 15명 300만원 / 20명 400만원 / 25명 500만원 / 30명 600만원', section: 'pro', anchor: 'pro-price', tags: '프로 단가 가격 비용 인원' },
  ...
  // 부가광고상품
  { title: '인스타그램 원브랜드 콘텐츠', desc: '부가광고상품 – 500만원, 팔로워 130만, 월 4개 한정', section: 'addon', anchor: 'addon-insta', tags: '인스타 부가광고 원브랜드' },
  { title: '크리에이터 SNS 업로드', desc: '부가광고상품 – 1인당 10만원, 인테리어 고관여자 대상 인스타 홍보', section: 'addon', anchor: 'addon-creator-sns', tags: '크리에이터 sns 인스타그램 업로드' },
  { title: '숏폼/릴스', desc: '부가광고상품 – 1인당 15만원, 오늘의집 인앱 & 인스타그램 릴스 업로드', section: 'addon', anchor: 'addon-shortform', tags: '숏폼 릴스 영상 동영상' },
  { title: '한달 사용 후기', desc: '부가광고상품 – 1인당 15만원, 2-Step 리뷰 최대 23장 에셋 확보', section: 'addon', anchor: 'addon-monthly', tags: '한달 사용후기 2step 장기리뷰' },
  ...
  { title: 'ROOKIE 단가 (루키)', desc: '1인당 3만원, 최소 10인(30만원) ~ 최대 50인(150만원)', section: 'rookie', anchor: 'rookie-price', tags: '루키 단가 가격 비용 인원' },
  ...
  // 체험단 효과 향상 TIP
  { title: '체험단 효과 향상 TIP', desc: '오감리뷰와 기획전·상품광고 병행 시 성과 향상 가이드', section: 'tips', anchor: 'tips-combo', tags: '효과 향상 팁 tip 체험단' },
  { title: '광고 병행 효과 (tips)', desc: '리뷰 후 기획전 병행 +110%, 상품광고 병행 +84% 주문건수 향상', section: 'tips', anchor: 'tips-combo', tags: '병행 기획전 상품광고 효과' },
